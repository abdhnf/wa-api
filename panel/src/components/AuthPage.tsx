          ...
          {authConfig.googleAuthEnabled && (
            <div className='space-y-3'>
              <button
                ...
                className='w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-gray-950 hover:bg-gray-850 active:bg-gray-800 border border-gray-800 hover:border-gray-700 rounded-xl text-xs font-semibold text-gray-200 transition shadow-sm disabled:opacity-50 cursor-pointer group'
              >
                {googleLoading ? (
                  <>
